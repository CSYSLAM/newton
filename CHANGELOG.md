...
- Add `softbody_franka_tet_grasp` example demonstrating a Franka Panda grasping a regular tetrahedral soft block with an explicit open -> first close -> lift motion sequence
