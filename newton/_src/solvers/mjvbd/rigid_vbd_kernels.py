...
def build_body_particle_contact_lists(
    ...
    """
    tid = wp.tid()
    active_contact_count = body_particle_contact_count[0]

    while tid < active_contact_count:
        ...
        tid += body_particle_contact_launch_dim
...
def step_body_body_contact_C0_lambda(
    ...
    if i >= rigid_contact_count[0]:
        ...
        if hard_contacts == 1:
            ...
            # registers in the frozen tangential offset, matching update_duals_body_body_contacts.
...
def init_body_particle_contacts(
    ...
    while i < active_contact_count:
        ...
        i += body_particle_contact_launch_dim
...
def update_duals_body_particle_contacts(
    ...
    while idx < active_contact_count:
