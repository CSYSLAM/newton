...
class SolverWCSPH(SolverBase):
    ...
    class Config:
        ...
        """Global pressure-stiffness override [Pa]. ``None`` uses per-particle values."""
    ...
    def register_custom_attributes(cls, builder: ModelBuilder) -> None:
        ...
        Attributes registered on Model (per-particle):
            ...
            - ``sph:viscosity``: Dynamic viscosity coefficient [Pa·s]
    ...
    def setup_collider(
        ...
        Args:
            ...
            body_com: Per-body center of mass [m] on the solver device for dynamic colliders.
            body_mass: Per-body mass [kg] on the solver device for dynamic colliders. Pass zeros for kinematic bodies.
            body_inv_inertia: Per-body inverse inertia [1/(kg·m²)] on the solver device for dynamic colliders.
            body_q: Per-body initial transform [m, unitless quaternion] on the solver device for dynamic colliders.
        """
    ...
    def collect_collider_impulses(
        ...
        Returns a tuple of 3 arrays:
            - Impulse values [N·s] in world coordinates.
            - Collider positions [m] in world coordinates.
    ...
    def project_outside(self, state_in: State, state_out: State, dt: float, gap: float | None = None) -> None:
        ...
        Args:
            ...
            dt: Time step [s] for estimating collider motion.
