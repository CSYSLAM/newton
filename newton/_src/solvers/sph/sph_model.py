...
def add_sph_particle_grid(
    ...
    *,
    ...
    Args:
        ...
        pos: Grid origin [m] in world coordinates.
        rot: Grid orientation as an xyzw quaternion. Defaults to identity.
        vel: Initial particle velocity [m/s]. Defaults to zero.
        ...
        jitter: Random position jitter [m] applied by ``ModelBuilder.add_particle_grid``.
