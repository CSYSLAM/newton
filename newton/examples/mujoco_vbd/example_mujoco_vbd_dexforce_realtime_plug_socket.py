...
"""Insert a rigid plug with realtime Dexforce W1 IK and SolverMuJoCoVBD.
...
Run, from the repository root::
    ...
    uv run --extra examples -m newton.examples \
        mujoco_vbd_dexforce_realtime_plug_socket
"""
...
class Example:
    ...
    def __init__(self, viewer, args):
        ...
        if self.solver.features.backend.value != "one_way_kinematic_full":
            raise RuntimeError(
                "Rigid plug/socket insertion requires the one_way_kinematic_full backend, "
