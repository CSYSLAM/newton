...
from newton.examples.sph._config import (
    _non_negative_float,
    _positive_float,
    _positive_int,
...
class Example:
    ...
    def __init__(self, viewer, args):
        ...
        fluid_builder = newton.ModelBuilder(up_axis=newton.Axis.Y, gravity=(0.0, args.gravity, 0.0))
        ...
        mechanism_builder = newton.ModelBuilder(up_axis=newton.Axis.Y, gravity=(0.0, 0.0, 0.0))
        add_sph_analytic_tank_shapes(
            mechanism_builder,
    ...
    def test_final(self):
        """Verify the coupled fluid and articulated flap remain finite."""
