    ...
    def create_articulation(self, builder: ModelBuilder) -> None:
        ...
        self.robot_key_poses = np.array(
            [
                ...
                [1.0, 24.0, -58.0, 18.0, *GRASP_QUAT, GRIPPER_OPEN],
                [0.8, 26.0, -58.0, 9.0, *GRASP_QUAT, GRIPPER_OPEN],
                [0.8, 26.0, -58.0, 9.0, *GRASP_QUAT, GRIPPER_CLOSED],
                [0.8, 21.0, -56.0, 17.0, *GRASP_QUAT, GRIPPER_CLOSED],
                [1.0, 12.0, -54.0, 28.0, *GRASP_QUAT, GRIPPER_CLOSED],
                [1.0, 3.0, -50.0, 18.0, *GRASP_QUAT, GRIPPER_CLOSED],
                [0.8, 3.0, -50.0, 11.0, *GRASP_QUAT, GRIPPER_OPEN],
                [0.8, 10.0, -52.0, 28.0, *GRASP_QUAT, GRIPPER_OPEN],
                [1.0, 8.0, -66.0, 18.0, *GRASP_QUAT, GRIPPER_OPEN],
                [0.8, 8.0, -66.0, 9.0, *GRASP_QUAT, GRIPPER_OPEN],
                [0.8, 8.0, -66.0, 9.0, *GRASP_QUAT, GRIPPER_CLOSED],
                [0.8, 8.0, -62.0, 17.0, *GRASP_QUAT, GRIPPER_CLOSED],
                [1.0, 5.0, -54.0, 28.0, *GRASP_QUAT, GRIPPER_CLOSED],
                [1.0, 2.0, -46.0, 18.0, *GRASP_QUAT, GRIPPER_CLOSED],
                [0.8, 2.0, -46.0, 11.0, *GRASP_QUAT, GRIPPER_OPEN],
                [1.0, 8.0, -50.0, 30.0, *GRASP_QUAT, GRIPPER_OPEN],
            ],
            dtype=np.float32,
        )
