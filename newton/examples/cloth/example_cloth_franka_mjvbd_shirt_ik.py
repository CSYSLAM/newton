...
###########################################################################
# Example Cloth Franka MJVBD Shirt IK
#
# Same shirt/table/Franka scene as ``example_cloth_franka_mjvbd_shirt.py``,
...
#
# Command: python -m newton.examples.cloth.example_cloth_franka_mjvbd_shirt_ik
#          python -m newton.examples cloth_franka_mjvbd_shirt_ik
#
###########################################################################
...
SHIRT_DENSITY = 0.02
SHIRT_POS = wp.vec3(0.0, 70.0, 30.0)
