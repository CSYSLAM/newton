...
#
# With --enable-franka: Franka follows the cube via IK + MJVBD.
# Without: Franka stays frozen, cloth drapes freely.
#
# Command: python -m newton.examples.cloth.example_cloth_franka_mjvbd_cloth
#          python -m newton.examples.cloth.example_cloth_franka_mjvbd_cloth --enable-franka
#
###########################################################################
    ...
    def create_articulation(self, builder: ModelBuilder) -> None:
        ...
        self.robot_key_poses = np.array(
            [
                ...
                [1.0, 22.0, -56.0, 18.0, *GRASP_QUAT, GRIPPER_CLOSED],
                [1.0, 16.0, -56.0, 25.0, *GRASP_QUAT, GRIPPER_CLOSED],
                [1.0, 10.0, -58.0, 35.0, *GRASP_QUAT, GRIPPER_CLOSED],
                [1.4, 1.0, -58.0, 30.0, *GRASP_QUAT, GRIPPER_CLOSED],
                [1.4, -16.0, -58.0, 25.0, *GRASP_QUAT, GRIPPER_CLOSED],
                [1.4, -28.0, -52.0, 20.0, *GRASP_QUAT, GRIPPER_CLOSED],
                [1.4, -30.0, -52.0, 10.0, *GRASP_QUAT, GRIPPER_CLOSED],
                [1.4, -35.0, -52.0, 30.0, *GRASP_QUAT, GRIPPER_OPEN],
            ],
            dtype=np.float32,
        )
