...
HOLD_TIME = 1.0
SECOND_APPROACH_TIME = 2.0
SECOND_GRASP_CLOSE_TIME = 1.2
SECOND_LIFT_TIME = 1.2
SECOND_FOLD_TRAVEL_TIME = 1.8
SECOND_FOLD_PLACE_TIME = 1.2
SECOND_RELEASE_TIME = 0.8
SECOND_RELEASE_LIFT_TIME = 1.2
RETURN_INITIAL_TIME = 2.0
    ...
    def _build_motion_segments(self) -> tuple[tuple[float, wp.transform, wp.transform, wp.transform, wp.transform, float, float], ...]:
        return (
            ...
            (
                SECOND_FOLD_TRAVEL_TIME,
                LEFT_SECOND_LIFT_TF,
                LEFT_SECOND_FOLD_TRAVEL_TF,
                RIGHT_SECOND_LIFT_TF,
                RIGHT_SECOND_FOLD_TRAVEL_TF,
                1.0,
                1.0,
            ),
            (
            ...
            (HOLD_TIME, LEFT_APPROACH_TF, LEFT_APPROACH_TF, RIGHT_APPROACH_TF, RIGHT_APPROACH_TF, 0.0, 0.0),
        )
