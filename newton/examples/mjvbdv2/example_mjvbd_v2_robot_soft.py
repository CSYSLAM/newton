...
"""MJVBDV2 dynamic/kinematic robot coupled one-way to a VBD tetrahedral soft body.

Run::

    python -m newton.examples mjvbd_v2_robot_soft --joint-mode dynamic
