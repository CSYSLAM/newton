...
Run ``uv run --extra examples -m newton.examples mjvbd_v2_w1_conveyor_sorting``.
...
from newton.examples.mjvbdv2 import example_vbd_mjvbd_v2_right_hand_inflatable_bag_recorder as bag_reference
