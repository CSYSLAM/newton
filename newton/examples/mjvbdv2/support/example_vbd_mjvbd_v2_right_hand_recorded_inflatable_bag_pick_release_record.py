...
Run from the repository root::
    ...
    uv run --extra examples -m newton.examples.mjvbdv2.support.example_vbd_mjvbd_v2_right_hand_recorded_inflatable_bag_pick_release_record
"""
...
ASSET_DIRECTORY = Path(__file__).resolve().parents[4] / "assets" / "vbd_mjvbd_v2"
