...
Run from the repository root::
    ...
    uv run --extra examples -m newton.examples.mjvbdv2.support.example_vbd_mjvbd_v2_right_hand_recorded_rigid_cube_into_bag --viewer gl
"""
...
from newton.examples.mjvbdv2.support import example_vbd_mjvbd_v2_right_hand_rigid_cube_recorder as recorder
