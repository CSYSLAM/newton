...
Run from the repository root::
    ...
    uv run --extra examples -m newton.examples.mjvbdv2.support.example_vbd_mjvbd_v2_dexforce_grasp_rigid_into_bag_coupled_proxy
"""
...
class Example:
    ...
    def _robot_urdf(self) -> Path:
        if self.args.robot_urdf:
            ...
            return path
        path = Path(__file__).resolve().parents[4] / "assets" / "DexforceW1V021" / "DexforceW1V021.urdf"
        if path.is_file():
            return path
