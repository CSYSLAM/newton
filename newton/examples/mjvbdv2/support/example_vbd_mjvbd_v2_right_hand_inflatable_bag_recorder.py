...
Run from the repository root::
    ...
    uv run --extra examples -m newton.examples.mjvbdv2.support.example_vbd_mjvbd_v2_right_hand_inflatable_bag_recorder --viewer gl
...
from newton.examples.mjvbdv2.support import example_vbd_mjvbd_v2_right_hand_rigid_cube_recorder as hand_recorder
...
class Example(hand_recorder.Example):
    ...
    def create_parser():
        ...
        output_dir = Path(__file__).resolve().parents[4] / "assets" / "vbd_mjvbd_v2"
        parser.add_argument(
            "--pose-output",
