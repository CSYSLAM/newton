...
Run the matching record example once, then play the resulting cache::
    ...
    uv run --extra examples -m newton.examples.mjvbdv2.support.example_vbd_mjvbd_v2_dexforce_recorded_soft_then_rigid_cube_into_bag_replay --viewer gl
"""
...
from newton.examples.mjvbdv2.support import (
    example_vbd_mjvbd_v2_dexforce_recorded_soft_then_rigid_cube_into_bag as simulation,
)
from newton.examples.mjvbdv2.support import (
