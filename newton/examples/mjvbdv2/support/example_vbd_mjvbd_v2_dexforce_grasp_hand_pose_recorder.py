...
Run from the repository root::
    ...
    uv run --extra examples -m newton.examples.mjvbdv2.support.example_vbd_mjvbd_v2_dexforce_grasp_hand_pose_recorder \
        --viewer gl
"""
...
from newton.examples.mjvbdv2.support import example_vbd_mjvbd_v2_dexforce_grasp_rigid_into_bag as grasp_example
...
class Example(grasp_example.Example):
    ...
    def create_parser():
        ...
        parser.add_argument(
            "--pose-output",
            default=str(
                Path(__file__).resolve().parents[4] / "assets" / "vbd_mjvbd_v2" / "vbd_mjvbd_v2_hand_pose.json"
            ),
        ...
        parser.add_argument(
            "--trajectory-output",
            default=str(
                Path(__file__).resolve().parents[4] / "assets" / "vbd_mjvbd_v2" / "vbd_mjvbd_v2_hand_trajectory.json"
            ),
