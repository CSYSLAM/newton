...
Run from the repository root::
    ...
    uv run --extra examples -m newton.examples.mjvbdv2.support.example_vbd_mjvbd_v2_right_hand_soft_then_rigid_cube_into_bag --viewer gl
"""
...
from newton.examples.mjvbdv2.support import example_vbd_mjvbd_v2_dexforce_recorded_soft_cube_into_bag as soft_reference
from newton.examples.mjvbdv2.support import example_vbd_mjvbd_v2_right_hand_soft_cube_recorder as recorder
from newton.solvers import SolverMJVBDV2

DEFAULT_GRASP_KEYFRAME = (
    Path(__file__).resolve().parents[4] / "assets" / "vbd_mjvbd_v2" / "vbd_w1_right_hand_last_keyframe.json"
)
FREE_SOFT_CONTACT = (
