...
###########################################################################
# Example Soft Body Franka Tet Grasp
#
...
#
# Command: python -m newton.examples softbody_franka_tet_grasp
#
###########################################################################
...
class Example:
    def __init__(self, viewer, args=None):
        ...
        self.robot_contacts = newton.Contacts(rigid_contact_max=0, soft_contact_max=0, device=self.model.device)
    ...
    def simulate(self):
        ...
        for _step in range(self.sim_substeps):
            ...
            self.robot_solver.step(self.state_0, self.state_1, self.control, self.robot_contacts, self.sim_dt)
