...
from newton.examples.vbd import example_vbd_mjvbd_v2_right_hand_recorded_rigid_cube_into_bag as rigid_demo
from newton.examples.vbd import example_vbd_mjvbd_v2_right_hand_recorded_soft_cube_into_bag as soft_demo
