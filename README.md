...
<table>
  ...
  <tr>
    <td colspan="3"><h3>MuJoCo Examples</h3></td>
  </tr>
  <tr>
    <td align="center" width="33%">
      <a href="https://github.com/newton-physics/newton/blob/main/newton/examples/mujoco/example_mujoco_box_packing.py">
        <img width="320" src="https://raw.githubusercontent.com/newton-physics/newton/main/docs/images/examples/example_mujoco_box_packing.jpg" alt="MuJoCo Box Packing">
      </a>
    </td>
  ...
  <tr>
    <td align="center" width="33%">
      <code>python -m newton.examples mujoco_box_packing</code>
    </td>
    <td align="center" width="33%"></td>
    <td align="center" width="33%"></td>
  </tr>
