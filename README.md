...
<table>
  ...
  <tr>
    <td align="center" width="33%">
      <a href="https://github.com/newton-physics/newton/blob/main/newton/examples/mpm/example_mpm_hanging_sheet.py">
        <img width="320" src="https://raw.githubusercontent.com/newton-physics/newton/main/docs/images/examples/example_mpm_hanging_sheet.jpg" alt="MPM Hanging Sheet">
      </a>
    </td>
    <td align="center" width="33%">
      <a href="https://github.com/newton-physics/newton/blob/main/newton/examples/mpm/example_mpm_suspended_sheet.py">
        <img width="320" src="https://raw.githubusercontent.com/newton-physics/newton/main/docs/images/examples/example_mpm_suspended_sheet.jpg" alt="MPM Suspended Sheet">
      </a>
    </td>
    <td align="center" width="33%">
      <a href="https://github.com/newton-physics/newton/blob/main/newton/examples/mpm/example_mpm_suspended_sheet_scissors.py">
        <img width="320" src="https://raw.githubusercontent.com/newton-physics/newton/main/docs/images/examples/example_mpm_suspended_sheet_scissors.jpg" alt="MPM Suspended Sheet Scissors">
      </a>
    </td>
  </tr>
  <tr>
    <td align="center" width="33%">
      <code>python -m newton.examples mpm_hanging_sheet</code>
    </td>
    <td align="center" width="33%">
      <code>python -m newton.examples mpm_suspended_sheet</code>
    </td>
    <td align="center" width="33%">
      <code>python -m newton.examples mpm_suspended_sheet_scissors</code>
    </td>
  </tr>
  <tr>
