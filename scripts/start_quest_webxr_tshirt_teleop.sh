...
export NEWTON_WEBXR_PEERS="newton-quest-webxr.service:8765 newton-quest-webxr-chair.service:8766 newton-quest-webxr-bag.service:8767 newton-quest-webxr-soft-rigid-bag.service:8768 newton-quest-webxr-nut-bolt.service:8770 newton-quest-webxr-nonwoven-bag.service:8771 newton-quest-webxr-gripper-plug.service:8772 newton-quest-webxr-w1-bag-packing.service:8773"
...
export NEWTON_WEBXR_RELOAD_SOURCES="${repo_root}/newton/examples/mjvbdv2/_webxr_teleop.py:${repo_root}/newton/examples/mjvbdv2/_webxr_w1_hand.py:${repo_root}/newton/examples/mjvbdv2/example_mjvbd_v2_tshirt_fold.py:${repo_root}/newton/examples/mjvbdv2/example_mjvbd_v2_webxr_tshirt_fold.py"
