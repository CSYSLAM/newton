...
export NEWTON_WEBXR_RELOAD_SOURCES="${repo_root}/newton/examples/mjvbdv2/_webxr_teleop.py:${repo_root}/newton/examples/mjvbdv2/_webxr_w1_hand.py:${repo_root}/newton/examples/mjvbdv2/example_cloth_mjvbd_v2_dexforce_bimanual_fold_tshirt_waic_house_final00.py:${repo_root}/newton/examples/mjvbdv2/example_cloth_mjvbd_v2_dexforce_webxr_bimanual_fold_tshirt_waic_house_final00.py"
